...
```{r distrito 3, eval=TRUE, echo=FALSE, fig.width=3.5, fig.align='center'}
lambayeque_mapa
```
...
```{r Piura Mapa, eval=TRUE, echo=FALSE, fig.width=3.5, fig.align='center'}
Piura_mapa
```
...
```{r San Martin Mapa, eval=TRUE, echo=FALSE, fig.width=3.5, fig.align='center'}
Sanmartin_mapa
```
...
```{r Tumbes Mapa, eval=TRUE, echo=FALSE, fig.width=3.5, fig.align='center'}
tumbes_mapa
```
...
```{r Madre de Dios Mapa, eval=TRUE, echo=FALSE, fig.width=3.5, fig.align='center'}
madrededios_mapa
```