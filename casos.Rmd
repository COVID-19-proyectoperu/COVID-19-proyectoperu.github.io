...
p1<-hospitalizados +   geom_point_interactive(aes(y = hospital,tooltip=hospital), col = "#8B1C62") + geom_line_interactive(aes(y = hospital, tooltip = hospital), stat = "identity", alpha=.5)
