...
<p>
<div style="text-align:justify"> Un *análisis por instrumentos* permite explorar las medidas que son seleccionadas por el gobierno de una “caja de herramientas” de cara a la ciudadanía en su estrategia para contener la expansión del COVID-19 en el Perú. Entonces, **¿Cómo podemos encontrarle un sentido a una diversidad de medidas que se han venido aplicando?** La repuesta es mediante la taxonomía NATO, originalmente trabajada por Christopher Hood en su texto *The Tools of Government: Public Policy and Politics* </div>
</p>
...
### 2.6. Conflictos sociales vinculados al Estado de Emergencia

Según el reporte de conflictos mensual emitido por la Defensoria del Pueblo, para el mes de marzo se registraron **18 acciones de protesta** vinculadas a la situación de emergencia por causa del COVID-19. En el mes de abril estas manifestaciones se han venido incrementando diariamente.
