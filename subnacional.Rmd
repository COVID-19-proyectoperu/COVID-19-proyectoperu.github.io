...
popup <- paste0("<b>", "Región: ", "</b>", as.character(mapacondata$DEPARTAMEN), "<br>",  
      ...
      "<b>", "Presupuesto Ejecutado: ", "</b>", as.character(mapacondata$presupuesto_covid_mapa), "<br>")
...
<p>
<div style="text-align:right"> Datos actualizados al 05/05/2020. Mapa elaborado por Manuel Ponte.</div>
</p>
